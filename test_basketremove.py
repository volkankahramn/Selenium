...
class TestBasketremove():
  ...
  def test_basketremove(self):
    ...
    WebDriverWait(self.driver, 3).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".shopping_cart_badge")))
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".shopping_cart_badge").text == "3"
    ...
    WebDriverWait(self.driver, 3).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".shopping_cart_link")))
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".shopping_cart_link")
